...
//        CGContextDrawLinearGradient(context, gradient, startPoint, endPoint, 0);
        CGContextSetFillColorWithColor(context, self.holderColor.CGColor);
        CGContextFillEllipseInRect(context, CGRectInset(currPoint, 1, 1));
...
- (void)setupDefaultAttributes {
    ...
    self.holderColor = [UIColor blueColor];
}
...
-(void)setBorderColor:(UIColor *)borderColor {
    ...
    borderView.borderColor = _borderColor;
}

-(void)setHolderColor:(UIColor *)holderColor {
    _holderColor = holderColor;
    borderView.holderColor = _holderColor;
}
